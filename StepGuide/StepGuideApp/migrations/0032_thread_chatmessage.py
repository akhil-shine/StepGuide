# Generated by Django 4.2.6 on 2024-02-13 06:20
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('StepGuideApp', '0031_alter_customuser_user_type'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('thread', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='chatmessage_thread', to='StepGuideApp.thread')),
